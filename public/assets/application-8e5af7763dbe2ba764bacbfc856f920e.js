...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=a586a49ed986884ddbd5)
 * Config saved to config.json and https://gist.github.com/a586a49ed986884ddbd5
 */
...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    ...
    if (this.formType == "select") {
      ...
      if (this.getValue() !== "") {
        this.sanitize ?  editor.element.text(this.getValue()) : editor.element.html(this.getValue());
      } else {
